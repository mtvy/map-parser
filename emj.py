...
EMJ_MAGNIFIER     = emoji.emojize(':magnifying_glass_tilted_right:' , use_aliases=True)
EMJ_FILE_BOX      = emoji.emojize(':card_file_box:'                 , use_aliases=True)
EMJ_BASKET        = emoji.emojize(':wastebasket:'                   , use_aliases=True)
